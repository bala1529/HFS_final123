...
class Config:
    ...
    # Set here or use environment: set VT_API_KEY=your_key
    VT_API_KEY = os.environ.get("VT_API_KEY", "ce4e0b7f977a9f59800f0a10b352fef8061e4ad06ff8332eb2174305364bfe30")
